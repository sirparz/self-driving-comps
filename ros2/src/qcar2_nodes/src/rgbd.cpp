    ...
    void publishImages()
    {
	    ...
	    {   
            ...
            else
            {
                ...
                // Instead of republishing an empty frame, skip publishing
                RCLCPP_WARN(this->get_logger(), "Skipping RGB frame publish due to retrieval failure.");
            }
            ...
            else
            {
                ...
                // Instead of republishing an empty frame, skip publishing
                RCLCPP_WARN(this->get_logger(), "Skipping Depth frame publish due to retrieval failure.");
            }
